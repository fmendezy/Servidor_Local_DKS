...
static void display_title(void) {
	...
	ShowMessage(""CL_PASS"     "CL_BOLD"                                                                 "CL_PASS""CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_PASS"       "CL_GREEN"              Servidor Local de Darknessfmy                       "CL_PASS""CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_PASS"       "CL_GREEN"          https://www.facebook.com/Darkness.vRO/                       "CL_PASS""CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_PASS"     "CL_BOLD"                                                                 "CL_PASS""CL_CLL""CL_NORMAL"\n");
